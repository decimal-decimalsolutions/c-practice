...
// Non-iterator Tests:
//
TEST_CASE("List::insertFront size", "[weight=2][part=1][valgrind]") {
    List<int> list;
...
TEST_CASE("List::insertBack size", "[weight=3][part=1][valgrind]") {
    List<int> list;
...
TEST_CASE("List::insert contents", "[weight=5][part=1][valgrind]") {
    List<int> list;
